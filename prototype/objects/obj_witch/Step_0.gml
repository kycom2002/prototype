...
else
{
	...
	if(place_meeting(x-8,y,obj_block) && block_ready)
	{
		...
		if(keyboard_check(vk_left))
		{
			show_debug_message("going left towards block");
			sprite_index = sp_witch_pushing;
			//hsp/=2;
			stamina-=1/10;
		}
	...
	vspd = 2;
	show_debug_message("panting: " + string(vspd));
